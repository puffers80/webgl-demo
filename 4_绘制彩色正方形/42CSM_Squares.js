...
function addSquare(x, y){
	...
	var HalfSize = MaxHalfSize * Math.random();//每个正方形的大小随机
	var vertices = [
	...
	var randColor1 = vec3(Math.random(),Math.random(),Math.random());
	var randColor2 = vec3(Math.random(),Math.random(),Math.random());
	var randColor3 = vec3(Math.random(),Math.random(),Math.random());
	var randColor4 = vec3(Math.random(),Math.random(),Math.random());
	var data = [];
	var colors = [
		randColor1,randColor2,randColor3,
		randColor1,randColor3,randColor4
	];
